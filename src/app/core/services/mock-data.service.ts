...
import { Gym, User, Member, Course, Subscription } from '../models';
...
export class MockDataService {
    ...
    getInitialGym(): Gym {
        return {
            id: 'gym-001',
            name: 'Fight Club Milano',
            logo: null,
            address: 'Via Roma 123, Milano',
            sports: ['boxing', 'kickboxing', 'mma', 'muaythai'],
            inviteCode: 'FCM2024',
            ownerId: 'user-001',
    ...
    getInitialSubscriptions(): Subscription[] {
        return [
            {
                id: 'sub-001',
                name: 'Open Mensile',
            ...
            {
                id: 'sub-004',
                name: 'Ingressi 10 Lezioni',
                price: 150,
                durationMonths: 6,
                gymId: 'gym-001',
                description: 'Pacchetto 10 ingressi da usare entro 6 mesi'
            }
        ];
    }
